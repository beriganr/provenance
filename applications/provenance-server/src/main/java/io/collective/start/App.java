...
import io.collective.endpoints.EndpointRecord;
...
public class App extends BasicApp {
    ...
    public void start() {
        ...
        Worker<EndpointTask> worker = new EndpointWorker(restTemplate, articleDataGateway);

        scheduler = new WorkScheduler<>(finder, List.of(worker), 300);
        scheduler.start();
    }
